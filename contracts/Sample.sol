...
contract Sample {
    ...
    constructor(address _wallet2) public onlyOwnerAccept {
    ...
    function reserve0() public {
        ...
        wallet2.transfer({value: 0, flag: MsgFlag.ALL_NOT_RESERVED}); // sends all rest balance
    ...
    function reserve1() public {
        ...
        wallet2.transfer({value: 0, flag: MsgFlag.ALL_NOT_RESERVED});
        ...
        // `wallet2.transfer` will send `all_balance` - `reserved_value` = 5.3 - 4.3 = 1 ever
